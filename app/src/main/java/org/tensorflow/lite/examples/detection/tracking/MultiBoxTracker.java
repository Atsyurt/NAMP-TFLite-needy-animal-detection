...
import org.tensorflow.lite.examples.detection.Nampmenu;
import org.tensorflow.lite.examples.detection.R;
import org.tensorflow.lite.examples.detection.Screenshoot;
...
//text is here
     // final String labelString ="gg";
      final String labelString=!TextUtils.isEmpty(recognition.title)
              ? String.format("%s %.2f", recognition.title, (100 * recognition.detectionConfidence))
              : String.format("%.2f", (100 * recognition.detectionConfidence));
      //            borderedText.drawText(canvas, trackedPos.left + cornerSize, trackedPos.top,
      // labelString);
      //logger.i(recognition.title);

      if(recognition.title.equals("cat")){
        logger.i("ayhan kedi bulundu");
        Intent intent = new Intent(context, Nampmenu.class);
        intent.putExtra("animal", "cat");
        context.startActivity(intent);
        //Screenshoot.takescreenshot(context.getResources().getResourceName(R.id.frame).);
        //View view = View.inflate(context, R.layout.activity_camera, null);
        //Screenshoot.takescreenshot(view);

      }
      else      if(recognition.title.equals("dog")){
        logger.i("ayhan köpek bulundu");
        Intent intent = new Intent(context, Nampmenu.class);
     ...
     else if(recognition.title.equals("bird")){
        logger.i("ayhan kuş bulundu");
        Intent intent = new Intent(context, Nampmenu.class);
